...
if exists("b:is_chicken") || exists("is_chicken")
    ...
    syn keyword schemeExtSyntax foreign-lambda foreign-lambda* define-external define-macro load-library definec bind-func bind-val
    syn keyword schemeExtSyntax define-instrument 
